...
import InstagramIcon from '../../lib/assets/icons/InstagramIcon';
import LinkedInIcon from '../../lib/assets/icons/LinkedInIcon';
import {
  FooterContainer,
      ...
      <FooterInnerContainer>
        <FooterCopyrightContainer>
          ...
          >
            ...
            designed worldwide with ❤️ by AI, climate and finance specialists.
          </Typography>
        </FooterCopyrightContainer>
